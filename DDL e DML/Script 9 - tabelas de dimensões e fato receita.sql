...
CREATE TABLE [STG].[dbo].fato_receita (
    ...
    surrogate_grupo INT,
    arrecadada_total DECIMAL(15, 2),
    arrecadada_fundeb_total DECIMAL(15, 2),
    data_carga DATE,
...
SELECT 
    ...
    dg.surrogate_grupo,
    SUM(s.arrecadada) AS arrecadada_total,
    SUM(s.arrecadada_fundeb) AS arrecadada_fundeb_total,
