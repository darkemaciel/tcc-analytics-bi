...
SELECT
    ...
    SUM(sdp.previsao_atualizada) AS previsao_atualizada_total,
    SUM(sdp.empenhada) AS empenhada_total,
    SUM(sdp.liquidada) AS liquidada_total,
    SUM(sdp.paga) AS paga_total,
